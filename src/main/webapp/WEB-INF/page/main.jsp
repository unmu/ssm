...
<body class="easyui-layout">
	<div data-options="region:'north',border:false" style="height:60px;background:#B3DFDA;padding:10px">
	    你好。<span style="color:red;">${users.userName }</span>
	</div>
	<div data-options="region:'west',split:true,title:'菜单栏'" style="width:150px;">
	    <div class="easyui-accordion" style="width:100%;height:100%;">
		    <c:forEach items="${users.role.menuList }" var="menu">
				<div title="${menu.menuName }" style="overflow:auto;" class="menu_li">
	...
	<div data-options="region:'south',border:false" style="height:50px;background:#A9FACD;padding:10px;text-align:center;">医疗门诊系统</div>
	<div data-options="region:'center',title:'主页面'">
	<iframe name="mainFrame" style="width:100%;height:99%;border:none;padding:10px;overflow:auto;"
	  src=""></iframe>
	</div>
</body>
</html>
